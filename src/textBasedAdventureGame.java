...
/**  Description:
 * This is a text based adventure game. It is console-based. This code uses the number that the player inputs to
 * determine the player's next move/ consequence.
 */
